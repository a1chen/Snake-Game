...
public class powerUps extends Rectangle{
	...
	Boolean shown = false, showWord1 = false, showWord2 = false, showWord3 = false, showWord4 = false, showWord5 = false, showWord6 = false;
	...
	public void draw(Graphics2D win) {
		if(!shown) {
			if(timer == timeDelay) {
				if(gen.nextInt(2) == 0) {
					this.setLocation(gen.nextInt(1600)+ 200, gen.nextInt(1600)+200);	
					shown = true;
				}
				timer = 0;
			}
		...
		if(showWord1 == true ) {
			if(displayTimer == displayDelay ) {
				...
				displayTimer++;
				win.drawString("Score Increase", 50, 1900);
			}
		...
		if(showWord2 == true ) {
			if(displayTimer == displayDelay ) {
				...
				displayTimer++;
				win.drawString("Enemy killed", 50, 1900);
			}
		}
		...
		if(showWord3 == true ) {
			if(displayTimer == displayDelay ) {
				...
				displayTimer++;
				win.drawString("Enemy speed increased", 50, 1900);
			}
		}
		...
		if(showWord4 == true ) {
			if(displayTimer == displayDelay ) {
				...
				displayTimer++;
				win.drawString("Enemy speed decreased", 50, 1900);
			}
		}
		...
		if(showWord5 == true ) {
			if(displayTimer == displayDelay ) {
				...
				displayTimer++;
				win.drawString("Snake speed increased", 50, 1900);
			}
		}
		...
		if(showWord6 == true ) {
			if(displayTimer == displayDelay ) {
				...
				displayTimer++;
				win.drawString("Snake speed decreased", 50, 1900);
			}
		}
	}
}
